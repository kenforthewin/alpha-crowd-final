class AddCachedVotesToTopics < ActiveRecord::Migration
  def self.up
    ...
    # Topic.find_each(&:update_cached_votes)
  end

  def self.down
    remove_column :topics, :cached_votes_total
    remove_column :topics, :cached_votes_score
    remove_column :topics, :cached_votes_up
    remove_column :topics, :cached_votes_down
    remove_column :topics, :cached_weighted_score
    remove_column :topics, :cached_weighted_total
    remove_column :topics, :cached_weighted_average
  end
end
