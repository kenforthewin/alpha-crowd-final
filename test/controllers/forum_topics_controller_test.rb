...
class ForumTopicsControllerTest < ActionController::TestCase
  ...
  test "should create forum_topic" do
    assert_difference('ForumTopic.count') do
      post :create, forum_topic: { forum_id: @forum_topic.forum_id, name: @forum_topic.name, user_id: @forum_topic.user_id }
    end
  ...
  test "should update forum_topic" do
    patch :update, id: @forum_topic, forum_topic: { forum_id: @forum_topic.forum_id, name: @forum_topic.name, user_id: @forum_topic.user_id }
    assert_redirected_to forum_topic_path(assigns(:forum_topic))
  end
